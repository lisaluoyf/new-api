...
func handleCozeEvent(c *gin.Context, event string, data string, responseText *string, usage *dto.Usage, id string, info *relaycommon.RelayInfo) {
	...
	case "conversation.chat.completed":
		...
		finishReason := "stop"
		stopResponse := helper.GenerateStopResponse(id, common.GetTimestamp(), service.FreeModelResponseName(info.OriginModelName, info.UpstreamModelName), finishReason)
