...
func migrateDB() error {
	if err := migrateUserSessionVersion(); err != nil {
		return err
	}
	...
	err := autoMigrateWithLimits(DB,
		...
		&TrialLimitNotification{},
		&CustomOAuthProvider{},
		&UserOAuthBinding{},
		&TelegramGroupVerification{},
		&DiscordGroupVerification{},
		&PerfMetric{},
		&AffLog{},
...
func migrateDBFast() error {
	...
	migrations := []struct {
		...
		{&Ability{}, "Ability"},
		{&Log{}, "Log"},
		{&RegistryAccessLog{}, "RegistryAccessLog"},
		{&Midjourney{}, "Midjourney"},
		{&TopUp{}, "TopUp"},
		{&WaffoRefund{}, "WaffoRefund"},
...
PRIMARY KEY (` + "`id`" + `)
	...
	required := []sqliteColumnDef{
		...
		{Name: "sold_out", DDL: "`sold_out` numeric DEFAULT 0"},
