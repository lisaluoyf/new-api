    ...
    build: (settings: BillingSettings) => (
      <QuotaSettingsSection
        defaultValues={{
          ...
          ReferralGPTRewardEnabled: settings.ReferralGPTRewardEnabled,
          ReferralGPTMinTopupUSD: settings.ReferralGPTMinTopupUSD,
          ReferralGPTRewardAmountUSD: settings.ReferralGPTRewardAmountUSD,
