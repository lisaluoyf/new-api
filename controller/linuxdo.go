...
func LinuxDoBind(c *gin.Context) {
	if !common.LinuxDOOAuthEnabled {
		common.ApiErrorI18n(c, i18n.MsgOAuthNotEnabled, map[string]any{"Provider": "Linux DO"})
		return
	}
	...
	if model.IsLinuxDOIdAlreadyTaken(user.LinuxDOId) {
		common.ApiErrorI18n(c, i18n.MsgOAuthAlreadyBound, map[string]any{"Provider": "Linux DO"})
		return
	}
