...
func AdminCreateSubscriptionPlan(c *gin.Context) {
	...
	if req.Plan.TierLevel < 0 || req.Plan.FiveHourAmount < 0 || req.Plan.SevenDayAmount < 0 {
		common.ApiErrorI18n(c, i18n.MsgSubscriptionTierQuotaNeg)
		return
	}
	if !model.IsSupportedSubscriptionPlanType(req.Plan.PlanType) {
		common.ApiErrorI18n(c, i18n.MsgSubscriptionInvalidType)
		return
	}
...
func AdminDeleteSubscriptionPlan(c *gin.Context) {
	...
	if !model.IsGPTPaidSubscriptionPlan(plan) && !model.IsCodingPlan(plan) {
		common.ApiErrorI18n(c, i18n.MsgSubscriptionPaidOnlyDelete)
		return
	}
	...
	if references > 0 {
		common.ApiErrorI18n(c, i18n.MsgSubscriptionHasRecords)
		return
	}
...
func AdminUpdateSubscriptionPlanStatus(c *gin.Context) {
	...
	if req.SoldOut != nil {
		...
		if !model.IsCodingPlan(&plan) {
			common.ApiErrorI18n(c, i18n.MsgSubscriptionSoldOutCoding)
			return
		}
...
func AdminInvalidateUserSubscription(c *gin.Context) {
	...
	if subId <= 0 {
		common.ApiErrorI18n(c, i18n.MsgSubscriptionInvalidSubId)
		return
	}
