...
func SyncUpstreamModels(c *gin.Context) {
	...
	wg.Wait()
	if fetchErr != nil {
		c.JSON(http.StatusOK, gin.H{"success": false, "code": i18n.MsgModelUpstreamFetchFailed, "message": common.TranslateMessage(c, i18n.MsgModelUpstreamFetchFailed, map[string]any{"Error": fetchErr.Error()}), "locale": req.Locale, "source_urls": gin.H{"models_url": modelsURL, "vendors_url": vendorsURL}})
		return
	}
...
func SyncUpstreamPreview(c *gin.Context) {
	...
	wg.Wait()
	if fetchErr != nil {
		c.JSON(http.StatusOK, gin.H{"success": false, "code": i18n.MsgModelUpstreamFetchFailed, "message": common.TranslateMessage(c, i18n.MsgModelUpstreamFetchFailed, map[string]any{"Error": fetchErr.Error()}), "locale": locale, "source_urls": gin.H{"models_url": modelsURL, "vendors_url": vendorsURL}})
		return
	}
