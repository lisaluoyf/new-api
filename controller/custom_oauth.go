...
func FetchCustomOAuthDiscovery(c *gin.Context) {
	...
	if wellKnownURL == "" && issuerURL == "" {
		common.ApiErrorI18n(c, i18n.MsgCustomOAuthDiscoveryRequired)
		return
	}
	...
	if err != nil || parsedURL.Host == "" || (parsedURL.Scheme != "http" && parsedURL.Scheme != "https") {
		common.ApiErrorI18n(c, i18n.MsgCustomOAuthDiscoveryURL)
		return
	}
	...
	if err != nil {
		common.ApiErrorI18n(c, i18n.MsgCustomOAuthDiscoveryCreate, map[string]any{"Error": err.Error()})
		return
	}
...
func DeleteCustomOAuthProvider(c *gin.Context) {
	...
	if err != nil {
		...
		common.ApiErrorI18n(c, i18n.MsgCustomOAuthBindingCheck)
		return
	}
	if count > 0 {
	...
	common.ApiSuccessMessageI18n(c, i18n.MsgDeleteSuccess)
}
