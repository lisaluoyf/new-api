...
func Setup2FA(c *gin.Context) {
	...
	if err != nil {
		common.ApiErrorI18n(c, i18n.MsgTwoFASecretFailed)
	...
	if err != nil {
		common.ApiErrorI18n(c, i18n.MsgTwoFABackupFailed)
...
func Enable2FA(c *gin.Context) {
	...
	common.ApiSuccessMessageI18n(c, i18n.MsgTwoFAEnableSuccess)
}
...
func Disable2FA(c *gin.Context) {
	...
	common.ApiSuccessMessageI18n(c, i18n.MsgTwoFADisableSuccess)
}
...
func RegenerateBackupCodes(c *gin.Context) {
	...
	c.JSON(http.StatusOK, gin.H{
		"success": true,
		"message": common.TranslateMessage(c, i18n.MsgTwoFABackupSuccess),
...
func AdminDisable2FA(c *gin.Context) {
	...
	if err != nil {
		common.ApiErrorI18n(c, i18n.MsgAuthUserIdFormatError)
		return
	}
	...
	common.ApiSuccessMessageI18n(c, i18n.MsgTwoFAAdminDisabled)
}
