...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			userRoute.POST("/internal/revoke-sessions", middleware.RequireApimasterInternalSync(), controller.RevokeInternalSessions)
			userRoute.POST("/internal/telegram-api-key", middleware.RequireMiaInternalService(), controller.ResolveMiaTelegramAPIKey)
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.POST("/client-error", controller.ReportClientError)
				...
				selfRoute.POST("/crypto/intent/:id/authorize", middleware.CriticalRateLimit(), controller.AuthorizeCryptoDepositIntent)
				selfRoute.POST("/crypto/intent/:id/cancel", middleware.CriticalRateLimit(), controller.CancelCryptoDepositIntent)
				...
				selfRoute.DELETE("/bindings/:binding_type", controller.ClearSelfBinding)
			}
		...
		subscriptionRoute.Use(middleware.UserAuth())
		{
			...
			subscriptionRoute.GET("/coding/plans", controller.GetCodingPlans)
			subscriptionRoute.POST("/coding/quote", controller.GetCodingPlanQuote)
		...
		adminRoute.Use(middleware.AdminAuth())
		{
			...
			adminRoute.GET("/channel-data/status-history", controller.GetChannelModelEvents)
