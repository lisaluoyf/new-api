...
func TestParseFreeModelRequirementsAcrossEndpoints(t *testing.T) {
	tests := []struct {
		...
		{"chat text", "/v1/chat/completions", `{"model":"apimaster-freemodel","messages":[{"role":"user","content":"hello"}]}`, false, false, false, false, false},
		{"chat vision tools", "/v1/chat/completions", `{"messages":[{"role":"user","content":[{"type":"text","text":"see"},{"type":"image_url","image_url":{"url":"https://example.test/a.png"}}]}],"tools":[{"type":"function","function":{"name":"x"}}],"tool_choice":"required"}`, true, true, false, false, true},
		{"responses schema", "/v1/responses", `{"input":[{"role":"user","content":[{"type":"input_image","image_url":"x"}]}],"text":{"format":{"type":"json_schema","name":"x","schema":{"type":"object"}}},"max_output_tokens":200}`, true, false, true, true, false},
		{"messages json", "/v1/messages", `{"messages":[{"role":"user","content":"x"}],"tools":[{"name":"x"}],"tool_choice":{"type":"any"},"output_config":{"format":{"type":"json_object"}},"max_tokens":100}`, false, true, true, false, true},
	}
